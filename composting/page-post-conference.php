...
?>
  ...
  <div id="side-right" class="widget-area">
    ...
    <img class="aligncenter wp-image-22118 size-full" src="http://compostingcouncil.org/wp/wp-content/uploads/2015/01/naturea-way.jpg" alt="Natures Way to Grow" width="250" height="339" />
  </div>
</div>
<?php get_sidebar(); ?>
<?php get_footer(); ?>
