...
<h1 class="entry-title">Jobs Wanted Page</h1>
...
<h1><?php the_title(); ?></h1>
	...
	<?php  echo "<strong>Deadline:</strong> ".date("F j, Y",strtotime(get_post_meta($post->ID,'deadline',true)))."<br>"; ?>
	 ...
	 <?php echo "<strong>Company:</strong> ".get_post_meta($id,'company',true)."<br>"; ?>
	<?php echo "<strong>Location:</strong> ".get_post_meta($id,'location',true)."<br>"; ?>
</div>
