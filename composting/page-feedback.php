...
<div id="sub-back-wrapper" style="  float:left; margin-right:6px;">
<div id="sub-back" style="height:20px; width:28px; padding-top:10px; font-size:24px; float:left; opacity:.7;">
 <a style=" margin-left:10px; " href="https://www.facebook.com/USCompostingCouncil" ><i class="fa fa-facebook"></i></a>
</div>
</div>

<div id="sub-back-wrapper" style="  float:left; margin-right:6px;">
<div id="sub-back" style="height:20px; width:28px; padding-top:9px; font-size:24px; float:left; opacity:.7;">
<a style="margin-left:5px;" href="http://www.linkedin.com/company/us-composting-council" ><i class="fa fa-linkedin"></i></a>
</div>
</div>
...
<div id="sub-back-wrapper" style="  float:left; margin-right:6px;">
<div id="sub-back" style="height:20px; width:28px; padding-top:9px; font-size:24px; float:left; opacity:.7;">
 <a style=" margin-left:4px;" href="https://twitter.com/USCompostingcou" ><i class="fa fa-twitter"></i></a>
</div>
</div>
