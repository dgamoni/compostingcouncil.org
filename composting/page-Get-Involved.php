...
?>
  ...
  <div id="side-right" class="widget-area">
    <a href="http://compostingcouncil.org/add-icaw-event/" title="Add Event" style="font-size: 14px; color: #333399; background-color:#E7EBEF"> <strong>Add Events Here</strong></a><br /><br />
    <?php  include("sidebar/sidebar-right-get-involved.php"); ?>
