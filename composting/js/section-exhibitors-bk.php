...
$exhibitors_contacts = array('name'=>'Name','email'=>'E-mail','phone'=>'Phone','reception'=>'Exhibitor Reception','tour'=>'Tour &amp; Equipment Demonstrations');
$exhibitors_required = array_flip(explode(' ', 'address city state zipcode country phone email'));
$exhibitors_cost_fields = explode(' ', 'display_type display_type_3_mult display_type_4_mult electrical additional_reps luncheon vegetarian');
		...
		<dl class="full">
			<dd>
				...
				<tr>
					...
					<td>$1375</td>
					<td>x <select id="display_type_4_mult" name="display_type_4_mult" maxlength="4" rel="1375" class="recalc_multiple display_type_4"  <?php disabled($post_data["display_type"],'3'); ?>>
...
function exhibitors_calculate($data,$post_id) {
	...
	switch  ($data['display_type']) {
		...
		case '4': $cost += 1375*$data['display_type_4_mult']; break;
	}
