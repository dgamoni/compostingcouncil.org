...
<input id="btnSubmit2"  onclick="return validate('registration')"  name="submitted" type="submit"
       value="SUBMIT &amp; COMPLETE more Registrations"/>
<input id="btnSubmit"  onclick="return validate('registration')"  name="submitted" type="submit"
       value="SUBMIT Registration &amp; CONTINUE to Payment"/>
</form>
</div>
</div>
