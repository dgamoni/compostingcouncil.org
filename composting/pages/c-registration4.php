...
if (isset($_GET['get_data_from']) && $_GET['get_data_from']) {
    ...
    //
    //                echo "user data: {}";
    //                var_export($amember_user);
    //                die;

    $amember_user = get_amember_member();
    ...
    $post_data['phone'] = $amember_user['phone'];
    $post_data['fax'] = $amember_user['fax'];
...
?>
<form id="registration" action="/admin/wp-content/themes/composting/post_custom.php" method="post"
...
<dl>
    ...
    <dd>
        <input type="text" name="post_title" id="name"
               value="<?php echo esc_attr(htmlspecialchars($post->post_title)); ?>" class="fill required w150"/>
    </dd>
    <dt><span class="required">*</span>
    ...
    <dd>
        <input type="text" name="phone" id="phone"
               value="<?php echo esc_attr(htmlspecialchars($post_data['phone'])); ?>" class="fill required w50"/>
    </dd>
    <dt>
        <label for="fax">Fax</label>
    </dt>
    <dd>
        <input type="text" name="fax" id="fax" value="<?php echo esc_attr(htmlspecialchars($post_data['fax'])); ?>"
               class="fill w50"/>
    </dd>
    <dt><span class="required">*</span>
    ...
    <dd>
        <input type="text" name="company" id="company"
               value="<?php echo esc_attr(htmlspecialchars($post_data['company'])); ?>" class="fill  required"/>
    </dd>
    <dt><span class="required">*</span>
    ...
    <dd>
        <input type="text" name="address" id="address"
               value="<?php echo esc_attr(htmlspecialchars($post_data['address'])); ?>" class="fill required"/>
    </dd>
    <dt><span class="required">*</span>
        <label for="city">City</label>
    </dt>
    <dd>
        <input type="text" name="city" id="city" value="<?php echo esc_attr(htmlspecialchars($post_data['city'])); ?>"
               class="fill required w50"/>
    </dd>
    <dt><span class="required">*</span>
    ...
    <dd>
        <input type="text" name="zipcode" id="zipcode"
               value="<?php echo esc_attr(htmlspecialchars($post_data['zipcode'])); ?>" class="fill required w25"
               maxlength="7"/>
    </dd>
    <dt><span class="required">*</span>
    ...
    <dd>
        <input type="text" name="email" id="email"
               value="<?php echo esc_attr(htmlspecialchars($post_data['email'])); ?>" class="fill required"/>
    </dd>
    <dt>
    ...
    <dd>
        <input type="text" name="website" id="website"
               value="<?php echo esc_attr(htmlspecialchars($post_data['website'])); ?>" class="fill"/>
    </dd>
</dl>
...
<dl>
    ...
    <dd>
        <input type="text" name="emergency_name" id="emergency_name"
               value="<?php echo esc_attr(htmlspecialchars($post_data['emergency_name'])); ?>" class="fill"/>
    </dd>
    <dt>
    ...
    <dd>
        <input type="text" name="emergency_phone" id="emergency_phone"
               value="<?php echo esc_attr(htmlspecialchars($post_data['emergency_phone'])); ?>" class="fill w50"/>
    </dd>
</dl>
...
<tr valign="top">
    ...
    <td><h2>
        <label for="registration_option_full">Full Conference Registration</label>
    </h2>
        <em>Includes sessions and session abstracts, exhibits, breakfasts, refreshment breaks, receptions &amp;
            equipment demonstrations &amp; tours</em></td>
</tr>
<tr valign="top">
    <td></td>
    <td class="if-full"><h3><span>Prior to <?php echo display_discount_date(); ?></span></h3>
        <table>
            <tr>
                <td width="22"><?php if (time() < strtotime($discount_date)): ?>
                    <input type="radio" id="full-member" name="rate" value="member" onclick="recalculate(this, 375);"
                           class="<?php if (!is_user_logged_in()) echo '" disabled="disabled'; else echo 'registration_option_full' ?>" <?php if ('full' == $post_data['registration_option']) checked($post_data['rate'], 'member'); ?>  />
                    <?php endif; ?></td>
                <th width="150" align="left"><label for="full-member">Member</label></th>
                <td>$375
                    <?php if (time() < strtotime($discount_date) && !is_user_logged_in()) echo "<span class='loggin_warning'>Must be a member to select option (<a href='<?php bloginfo('url'); ?>/members-login/'>Login</a> or <a href='<?php bloginfo('url'); ?>/admin/apply.php'>Join</a>)</span>"; ?></td>
            </tr>
            <?php if (!is_user_logged_in()): ?>
            <tr>
                <td><?php if (time() < strtotime($discount_date)): ?>
                    <input type="radio" id="full-nonmember" name="rate" value="nonmember"
                           onclick="recalculate(this, 445);"
                           class="registration_option_full" <?php if ('full' == $post_data['registration_option']) checked($post_data['rate'], 'nonmember'); ?> />
                    <?php endif; ?></td>
            ...
            <tr>
                <td><?php if (time() < strtotime($discount_date)): ?>
                    <input type="radio" id="full-speaker" name="rate" value="speaker" onclick="recalculate(this, 250);"
                           class="registration_option_full" <?php if ('full' == $post_data['registration_option']) checked($post_data['rate'], 'speaker'); ?> />
                    <?php endif; ?></td>
        ...
        <table>
            <tr>
                <td width="22"><?php if (time() > strtotime($discount_date)): ?>
                    <input type="radio" id="full-member" name="rate" value="member" onclick="recalculate(this, 395);"
                           class="<?php if (!is_user_logged_in()) echo '" disabled="disabled'; else echo 'registration_option_full' ?>" <?php if ('full' == $post_data['registration_option']) checked($post_data['rate'], 'member'); ?>  />
                    <?php endif; ?></td>
                <th width="150" align="left"><label for="full-member">Member</label></th>
                <td>$395
        ...
        <table>
            <tr valign="top">
                <td><input type="checkbox" id="tours" name="tour" value="yes"
        ...
        <table width="452">
            <tr>
                <td width="22"><input type="checkbox" id="reception" value="yes" name="reception"
                                      class="registration_option_full" <?php if ('full' == $post_data['registration_option']) checked($post_data['reception'], 'yes'); ?> />
                </td>
                <th width="350" align="left"><label for="reception">Exhibitors Reception | Wednesday, January 18</label>
                </th>
                <td width="53">&nbsp;</td>
            </tr>
            <tr>
                <td width="22"><input type="checkbox" id="reception2" value="yes" name="reception2"
                                      class="registration_option_full" <?php if ('full' == $post_data['registration_option']) checked($post_data['reception2'], 'yes'); ?> />
                </td>
                <th width="350" align="left"><label for="reception2">BPI Reception | Thursday, January 19</label></th>
                <td width="53">&nbsp;</td>
            </tr>
        </table>
        <h3>Awards Luncheon | Wednesday, Jan 18</h3>
        <table>
            <tr valign="top">
            ...
            <tr valign="top">
                <td><input type="checkbox" id="vegetarian" name="vegetarian" value="yes"
...
<tr valign="top">
    ...
    <td><h2>
        <label for="registration_option_one-day">Conference Registration 1 Day</label>
    </h2>
        <em>Includes sessions and session abstracts, exhibits, breakfasts, refreshment breaks &amp; receptions</em></td>
</tr>
<tr valign="top">
    <td></td>
    <td class="if-one-day"><h3><span>One Day Pass</span></h3>
        <table>
            <tr>
                ...
                <th width="150" align="left"><label for="one-day-1">Wednesday, January 18</label></th>
            </tr>
            <tr>
                ...
                <th align="left"><label for="one-day-2">Thursday, January 19</label></th>
            </tr>
        </table>
        ...
        <table>
            <tr>
                <td width="22"><?php if (time() < strtotime($discount_date)): ?>
                    <input type="radio" id="one-day-member" name="rate" value="one-day-member"
                           onclick="recalculate(this, 225);"
                           class="<?php if (!is_user_logged_in()) echo '" disabled="disabled'; else echo 'registration_option_one-day' ?>" <?php if ('one-day' == $post_data['registration_option']) checked($post_data['rate'], 'one-day-member'); ?> />
                    <?php endif; ?></td>
                <th width="150" align="left"><label for="one-day-member">Member</label></th>
                <td>$225
                    <?php if (time() < strtotime($discount_date) && !is_user_logged_in()) echo "<span class='loggin_warning'>Must be a member to select option (<a href='http://www.compostingcouncil.org/registration.php'>Register</a>)</span>"; ?></td>
            </tr>
            <?php if (!is_user_logged_in()): ?>
            <tr>
                <td><?php if (time() < strtotime($discount_date)): ?>
                    <input type="radio" id="one-day-nonmember" name="rate" value="one-day-nonmember"
                           onclick="recalculate(this, 255);"
                           class="registration_option_one-day" <?php if ('one-day' == $post_data['registration_option']) checked($post_data['rate'], 'one-day-nonmember'); ?> />
                    <?php endif; ?></td>
        ...
        <table width="450">
            <tr>
                <td width="29"><input type="checkbox" id="reception" name="reception" value="yes"
                                      class="registration_option_one-day one-day-1" <?php if ('one-day' == $post_data['registration_option']) checked($post_data['reception'], 'yes'); ?> />
                </td>
                <th width="330" align="left"><label for="reception">Exhibitors Reception | Wednesday, January 18</label>
                </th>
                <td width="75">&nbsp;</td>
            </tr>
            <tr>
                <td width="29"><input type="checkbox" id="reception2" name="reception2" value="yes"
                ...
                <th width="330" align="left"><label for="reception2">BPI Reception | Thursday, January 19</label></th>
                <td width="75">&nbsp;</td>
            </tr>
        </table>
...
<tr valign="top">
    ...
    <td><h2>
        ...
        <em>NOTE that the facility tour is INCLUDED in conference registration fees</em></td>
</tr>
    ...
    <td>
        <table>
            <tr>
                ...
                <th width="350" align="left"><label for="rate-tour-only">Equipment Demonstrations &amp; Facility
                    Tour</label></th>
                <td>$55</td>
            </tr>
        </table>
...
<tr valign="top">
    ...
    <td><h2>
        <label for="registration_option_tradeshow">Trade Show Only</label>
    </h2>
        <em>Includes program guide, exhibits, refreshment breaks &amp; receptions</em></td>
</tr>
    ...
    <td>
        ...
        <table>
            <tr>
                ...
                <th width="150" align="left"><label for="tradeshow-day-1">Wednesday, January 18</label></th>
            </tr>
            <tr>
                <td width="22"></td>
                ...
                <th align="left"><label for="tradeshow-day-2">Thursday, January 19</label></th>
            </tr>
        </table>
        <table>
            <tr>
        ...
        <table width="446">
            <tr>
                ...
                <th width="375" align="left"><label for="reception">Exhibitors Reception | Wednesday, January 18</label>
                </th>
                <td width="33"></td>
            </tr>
            <tr>
                ...
                <th width="375" align="left"><label for="reception2">BPI Reception | Thursday, January 19</label></th>
                <td width="33"></td>
            </tr>
        </table>
    </td>
...
<h2>Certification Exam | Thursday, Jan 19</h2>
...
<table>
    <tr valign="top">
        <td width="22"><input type="radio" name="exam" value="no"
                              onclick="recalculate(this, 0);" <?php checked($post_data['exam'], 'no'); ?> /></td>
        <th width="150" align="left">None</th>
        <td></td>
    </tr>
    <tr valign="top">
        <td><input type="radio" name="exam" value="member"
                   onclick="recalculate(this, 175);" <?php if (!is_user_logged_in()) echo 'disabled="disabled"' ?> <?php checked($post_data['exam'], 'member'); ?> />
        </td>
        <th align="left">USCC or SWANA Member</th>
        <td>$175
            <?php if (!is_user_logged_in()) echo "<span class='loggin_warning'>Must be a member to select option (<a href='http://www.compostingcouncil.org/registration.php'>Register</a>)</span>"; ?></td>
    </tr>
    <?php if (!is_user_logged_in()): ?>
    <tr valign="top">
...
<h2>Pre-Conference Training &amp; Workshops | Tuesday, Jan 17</h2>
<table id="workshops">
    <tr>
        <th colspan="2"></th>
        <th align="right" style="white-space:nowrap;"><label>
            <input type="radio" id="workshop_rate_memeber" name="workshop_rate"
                   value="member" <?php if (!is_user_logged_in()) echo 'disabled="disabled"' ?> <?php checked($post_data['workshop_rate'], 'member'); ?> />
            Member</label></th>
        <th align="right" style="white-space:nowrap;"> <?php if (!is_user_logged_in()): ?>
            <label>
                <input type="radio" id="workshop_rate_nonmemeber" name="workshop_rate"
...
<p>
    <strong>Please input the correct answer:</strong><br/>
    <img src='<?php bloginfo('url'); ?>/admin/catcta.php'> <br/>
    <input type='text' name='catcta' class='required' size=10/> <br/>
</p>
<input id="btnSubmit2" onclick="return validate_with_catcta();" name="submitted" type="submit"
       value="SUBMIT AND COMPLETE MORE REGISTRATIONS"/>
<input id="btnSubmit" onclick="return validate_with_catcta();" name="submitted" type="submit"
       value="SUBMIT REGISTRATION AND CONTINUE TO PAYMENT"/>
</form>
</div>
</div>
...
<script type="text/javascript">
    ...
    function validate_with_catcta() {
        if (validate('registration')) {
            jQuery.post('/admin/catcta_get.php', {'catcta':jQuery('input[name=catcta]').val()}, function(data) {
                if (data == 1) {
                    jQuery("#registration").submit();
                    return true;
                } else {
                    alert('Please input correct catcta!');
                    jQuery('input[name=catcta]').focus();
                }
            })
        }
        return false;
