...
?>
    <form id="registration" action="/admin/wp-content/themes/composting/post_custom.php" method="post" enctype="multipart/form-data">
      ...
      <dl>
        ...
        <dd>
          <input type="text" name="post_title" id="name" value="<?php echo esc_attr( htmlspecialchars( $post->post_title ) ); ?>" class="fill required w150" />
        </dd>
        <dt><span class="required">*</span>
          <label for="phone">Phone</label>
        </dt>
        <dd>
          <input type="text" name="phone" id="phone" value="<?php echo esc_attr( htmlspecialchars( $post_data['phone'] ) ); ?>" class="fill required w50" />
        </dd>
        <dt>
          <label for="fax">Fax</label>
        </dt>
        <dd>
          <input type="text" name="fax" id="fax" value="<?php echo esc_attr( htmlspecialchars( $post_data['fax'] ) ); ?>" class="fill w50" />
        </dd>
        <dt><span class="required">*</span>
          <label for="company">Company</label>
        </dt>
        <dd>
          <input type="text" name="company" id="company" value="<?php echo esc_attr( htmlspecialchars( $post_data['company'] ) ); ?>" class="fill  required" />
        </dd>
        <dt><span class="required">*</span>
      ...
      <dl>
        ...
        <dd>
          <input type="text" name="emergency_name" id="emergency_name" value="<?php echo esc_attr( htmlspecialchars( $post_data['emergency_name'] ) ); ?>" class="fill" />
        </dd>
        <dt>
          <label for="emergency_phone">Phone</label>
        </dt>
        <dd>
          <input type="text" name="emergency_phone" id="emergency_phone" value="<?php echo esc_attr( htmlspecialchars( $post_data['emergency_phone'] ) ); ?>" class="fill w50" />
        </dd>
      </dl>
      <table cellpadding="0" cellspacing="0" width="100%" style="font-size: 135%">
        <tr valign="top">
          ...
          <td><h2>
            ...
            <em>Includes sessions and session abstracts, exhibits, breakfasts, refreshment breaks, receptions &amp; equipment demonstrations &amp; tours</em></td>
        </tr>
        <tr valign="top">
          <td></td>
          <td class="if-full"><h3><span>Prior to <?php echo display_discount_date(); ?></span></h3>
            <table>
              <tr>
                <td width="22"><?php if (time()<strtotime($discount_date)): ?>
                  <input type="radio" id="full-member" name="rate" value="member" onclick="recalculate(this, 375);" class="<?php if (!is_user_logged_in()) echo '" disabled="disabled'; else echo 'registration_option_full' ?>" <?php if ('full' == $post_data['registration_option']) checked($post_data['rate'],'member'); ?>  />
                  <?php endif; ?></td>
              ...
              <tr>
                <td><?php if (time()<strtotime($discount_date)): ?>
                  <input type="radio" id="full-nonmember" name="rate" value="nonmember" onclick="recalculate(this, 445);" class="registration_option_full" <?php if ('full' == $post_data['registration_option']) checked($post_data['rate'],'nonmember'); ?> />
                  <?php endif; ?></td>
              ...
              <tr>
                <td><?php if (time()<strtotime($discount_date)): ?>
                  <input type="radio" id="full-speaker" name="rate" value="speaker" onclick="recalculate(this, 250);" class="registration_option_full" <?php if ('full' == $post_data['registration_option']) checked($post_data['rate'],'speaker'); ?> />
                  <?php endif; ?></td>
            ...
            <table>
              <tr>
                <td width="22"><?php if (time()>strtotime($discount_date)): ?>
                  <input type="radio" id="full-member" name="rate" value="member" onclick="recalculate(this, 395);" class="<?php if (!is_user_logged_in()) echo '" disabled="disabled'; else echo 'registration_option_full' ?>" <?php if ('full' == $post_data['registration_option']) checked($post_data['rate'],'member'); ?>  />
                  <?php endif; ?></td>
                <th width="150" align="left"><label for="full-member">Member</label></th>
                <td>$395
                  <?php if (time()>strtotime($discount_date) && !is_user_logged_in()) echo "<span class='loggin_warning'>Must be a member to select option (<a href='http://www.compostingcouncil.org/registration.php'>Register</a>)</span>"; ?></td>
              ...
              <tr>
                <td><?php if (time()>strtotime($discount_date)): ?>
                  <input type="radio" id="full-nonmember" name="rate" value="nonmember" onclick="recalculate(this, 495);" class="registration_option_full" <?php if ('full' == $post_data['registration_option']) checked($post_data['rate'],'nonmember'); ?>  />
                  <?php endif; ?></td>
                <th align="left"><label for="full-nonmember">Non-Member</label></th>
                <td>$495</td>
              </tr>
        ...
        <tr valign="top">
          ...
          <td class="if-one-day"><h3><span>One Day Pass</span></h3>
            ...
            <table>
              <tr>
                <td width="22"><?php if (time()<strtotime($discount_date)): ?>
                  <input type="radio" id="one-day-member" name="rate" value="one-day-member" onclick="recalculate(this, 225);" class="<?php if (!is_user_logged_in()) echo '" disabled="disabled'; else echo 'registration_option_one-day' ?>" <?php if ('one-day' == $post_data['registration_option']) checked($post_data['rate'],'one-day-member'); ?> />
                  <?php endif; ?></td>
              ...
              <tr>
                <td><?php if (time()<strtotime($discount_date)): ?>
                  <input type="radio" id="one-day-nonmember" name="rate" value="one-day-nonmember" onclick="recalculate(this, 255);" class="registration_option_one-day" <?php if ('one-day' == $post_data['registration_option']) checked($post_data['rate'],'one-day-nonmember'); ?> />
                  <?php endif; ?></td>
            ...
            <table>
              <tr>
                <td width="22"><?php if (time()>strtotime($discount_date)): ?>
                  <input type="radio" id="one-day-member" name="rate" value="one-day-member" onclick="recalculate(this, 245);" class="<?php if (!is_user_logged_in()) echo '" disabled="disabled'; else echo 'registration_option_one-day'; ?>" <?php if ('one-day' == $post_data['registration_option']) checked($post_data['rate'],'one-day-member'); ?> />
                  <?php endif; ?></td>
                <th width="150" align="left"><label for="one-day-member">Member</label></th>
                <td>$245
                  <?php if (time()>strtotime($discount_date) && !is_user_logged_in()) echo "<span class='loggin_warning'>Must be a member to select option (<a href='http://www.compostingcouncil.org/registration.php'>Register</a>)</span>"; ?></td>
              ...
              <tr>
                <td><?php if (time()>strtotime($discount_date)): ?>
                  <input type="radio" id="one-day-nonmember" name="rate" value="one-day-nonmember" onclick="recalculate(this, 280);" class="registration_option_one-day" <?php if ('one-day' == $post_data['registration_option']) checked($post_data['rate'],'one-day-nonmember'); ?> />
                  <?php endif; ?></td>
                <th align="left"><label for="one-day-nonmember">Non-Member</label></th>
                <td>$280</td>
              </tr>
        ...
        <tr valign="top" class="if-tour">
          ...
          <td><table>
              <tr>
                ...
                <th width="350" align="left"><label for="rate-tour-only">Equipment Demonstrations &amp; Facility Tour</label></th>
                <td>$55</td>
              </tr>
            </table></td>
        </tr>
      ...
      <table id="workshops">
        <tr>
          ...
          <th align="right" style="white-space:nowrap;"><label>
              <input type="radio" id="workshop_rate_memeber" name="workshop_rate" value="member" <?php if (!is_user_logged_in()) echo 'disabled="disabled"' ?> <?php checked($post_data['workshop_rate'],'member'); ?> />
              Member</label></th>
          <th align="right" style="white-space:nowrap;"> <?php if (!is_user_logged_in()): ?>
            <label>
              <input type="radio" id="workshop_rate_nonmemeber" name="workshop_rate" value="nonmember" <?php checked($post_data['workshop_rate'],'nonmember'); ?> />
              Non-Member</label>
            <?php endif; ?>
          </th>
        </tr>
