...
<div id="warning-box-wrapper2">
<div id="warning-box">  <a href="http://compostingcouncil.org/add-icaw-event/" title="Add Event" style="font-size: 14px; margin-left: 7px;"> Add Event Here</a></div></div>
    <?php  include("sidebar/sidebar-right-ICAW-event.php"); ?>
  </div>
</div>
<?php get_sidebar(); ?>
<?php get_footer(); ?>
