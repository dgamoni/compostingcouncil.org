<?php 
/*
Template Name: Summer Newsletter 1
*/
?>
...
<div><a href="<?php bloginfo('url'); ?>/contact/" target="_blank"><img title="Your Ad Here" src="<?php bloginfo('url'); ?>/wp/wp-content/uploads/2014/06/ad.gif" alt="Compost Operations Training Courses 2014" width="220" height="104" /></a>
</div>
