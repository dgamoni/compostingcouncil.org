...
if (!file_exists('../amember/dbconf.php')) die ('dbconf.php not found');

include '../amember/dbconf.php';

global $wpdb;

mysql_connect($pc['host'], $pc['user'], $pc['pass']);

mysql_select_db('compos_amember');

$sql_comp = "SELECT organization FROM amember_members  m
WHERE organization != ''";

$s = mysql_query($sql_comp);
...
<? include TEMPLATEPATH . "/sidebar/home.php"; ?><br />
<br />

<?php // include TEMPLATEPATH . "/sidebar/sidebar-dir.php"; ?>
