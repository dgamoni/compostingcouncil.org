...
<?php comments_template( '/includes/comments.php'); ?>
  ...
  <div id="side-right" class="widget-area"> <a href="http://portal.compostingcouncil.org/ItemDetail?iProductCode=2018_CONF&Category=CONF_PRO&WebsiteKey=f05a7d33-3967-4bd0-b396-5b4ff841ca17" target="_blank"><img style="border:1px solid #bfdfeb;padding:2px; margin-bottom:12px;" src="https://compostingcouncil.org/wp-content/uploads/2018/02/key-card.png" width="220" height="344" alt=""/></a>
