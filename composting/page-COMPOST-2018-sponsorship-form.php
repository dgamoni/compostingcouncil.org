<?php 
/*
Template Name: COMPOST 2018 Sponsorship Form
*/
?>
...
?>
  ...
  <p style="font-size: 14px;  background-color: #ffffff; background-position: left top; background-repeat: repeat-x; border: 1px solid #ffcc99; padding: 7px; text-align: center;"><a href="http://compostingcouncil.org/sponsors/"><strong>See our 2018 Sponsors here!</strong></a></p>
