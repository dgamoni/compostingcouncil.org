...
Template Name: Persistent Herbicides History
...
<div id="container">
  ...
  <p> <a href="<?php bloginfo('url'); ?>/current-alerts-and-campaigns/#PHfund" target="_blank"><img src="<?php echo site_url(); ?>/wp-content/uploads/2012/12/donate21.jpg" border="0"; margin-bottom:10px;" /></a></p>
...
?>
  ...
  <strong>Thank you to all our "Fight Persistent Herbicide" Fund contributors:</strong><hr>



A1 Organics <br>

Bland Landscaping Co.<br>

Cami & Michael Whitt<br>

Cary Oshins<br>

Chaz Miller<br>

Compost International<br>

Creech Services, Inc.<br>
