...
<p> <a href="#PHfund"><img src="<?php echo site_url(); ?>/wp-content/uploads/2012/12/donate21.jpg" border="0"; margin-bottom:10px;" /></a></p>
  ...
  <div id="content">
  <h2 style="margin-left:20px; margin-right:20px;">DONATE TO THE “FIGHT PERSISTENT HERBICIDES FUND”</h2>
 ...
 <?php } elseif  (is_page('4534') ) { ?>

        <?php include(TEMPLATEPATH . '/pages/donation-support-demo.php'); ?>
