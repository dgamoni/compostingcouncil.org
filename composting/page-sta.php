  ...
  <div id="content" style="width:710px;">
    ...
    <div id="post">
        <div class="entry-content" style="">
            ...
            <?php if ((is_user_logged_in() && is_sta_member()) || current_user_can('administrator')) { ?>
            ...
            <?php if ((is_user_logged_in() && is_sta_member()) || current_user_can('administrator')) { ?>
                ...
                <div id="warning-box-wrapper">
                    <div id="warning-box">STA Member only area. If you are a member, please log in.</div>
                </div>
                <?php }
            ; ?>
