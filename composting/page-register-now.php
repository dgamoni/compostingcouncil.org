...
?>
  ...
  <div id="side-right" class="widget-area">
    <?php  include("sidebar/sidebar-right-noad.php"); ?>
      <p>
<a href="http://compostingcouncil.org/compost2017/" title="Register Now!">
<img class="aligncenter size-full wp-image-26341" width="180" height="72" alt="Reg Now!" src="http://compostingcouncil.org/wp/wp-content/uploads/2016/09/button-reg-now.jpg" title="Register Now!" style="border: 1px solid #bfdfeb; padding: 1px; margin-left:15px;">
</a>
</p>  
<p style="color: green; font-size: 15px;">Got questions? <a href="http://compostingcouncil.org/compost2017-faq/">Read our FAQs</a>!</p>
  </div>
</div>
<?php get_sidebar(); ?>
<?php get_footer(); ?>
