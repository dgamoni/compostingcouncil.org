<?php 
/*
Template Name: Newsletter Partners
*/
?>
...
?>
  ...
  <!--MIDDLE SECTION-->
 <div id="side-right" class="widget-area"> <a href="http://americarecyclesday.org/" target="_blank"><img width="180" src="http://compostingcouncil.org/wp/wp-content/uploads/2014/10/ARD.jpg" style="border:1px solid #bfdfeb; padding:2px; margin-left: 15px; margin-bottom: 7px;"></a>
