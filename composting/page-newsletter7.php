...
<br>
     <div><a href="<?php bloginfo('url'); ?>/training/" target="_blank"><img title="Compost Opertations Training Courses 2014" src="<?php bloginfo('url'); ?>/wp/wp-content/uploads/2014/04/Compost-Operations-Training-Ad.jpg" alt="Compost Opertations Training Courses 2014" width="300" height="469" /></a>
</div>    
  </div>  
</div>
<?php get_sidebar(); ?>
